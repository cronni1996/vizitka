<template>
  <div class="d-flex flex-column flex-shrink-0 bg-light" style="width: 4.5rem;">
    <a href="/" class="d-block p-3 link-dark text-decoration-none" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Icon-only">
      ...
      <span class="visually-hidden"><ya-tr-span data-index="23-0" data-translated="false" data-source-lang="en" data-target-lang="ru" data-value="Icon-only" data-translation="Только для значков" data-ch="0" data-type="trSpan">Icon-only</ya-tr-span></span>
    </a>
    ...
    <div class="dropdown border-top">
      ...
      <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser3">
        <li><a class="dropdown-item" href="#"><ya-tr-span data-index="24-0" data-translated="false" data-source-lang="en" data-target-lang="ru" data-value="New project..." data-translation="Новый проект..." data-ch="1" data-type="trSpan">New project...</ya-tr-span></a></li>
        <li><a class="dropdown-item" href="#"><ya-tr-span data-index="25-0" data-translated="false" data-source-lang="en" data-target-lang="ru" data-value="Settings" data-translation="Настройки" data-ch="1" data-type="trSpan">Settings</ya-tr-span></a></li>
        <li><a class="dropdown-item" href="#"><ya-tr-span data-index="26-0" data-translated="false" data-source-lang="en" data-target-lang="ru" data-value="Profile" data-translation="Профиль" data-ch="1" data-type="trSpan">Profile</ya-tr-span></a></li>
        <li><hr class="dropdown-divider"></li>
        <li><a class="dropdown-item" href="#"><ya-tr-span data-index="27-0" data-translated="false" data-source-lang="en" data-target-lang="ru" data-value="Sign out" data-translation="Выход" data-ch="1" data-type="trSpan">Sign out</ya-tr-span></a></li>
      </ul>
    </div>
  </div>
